...
import SDenseLayer # customized lasagne layers for asymmetric backpropagation

numpy.random.seed(25)

# build a slightly deeper network to see the what the asymmetric gradient can do
def build_net(input_var):

    # data is cifar-10, which is 32*32*3 = 3072
    ...
    # possibly using asymmetric backpropagation or original one
...
# either choose hinge loss or crossentropy
